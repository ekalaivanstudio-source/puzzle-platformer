...
public class AudioManager : MonoBehaviour
{
    ...
    {
        if (m_MusicSource != null) m_MusicSource.volume = m_MasterVolume * m_MusicVolume;
        float sfx = m_MasterVolume * m_SfxVolume;
    ...
    public void PlayQueue()         => PlaySfx(m_QueueClip);
    public void PlaySubmit()        => PlaySfx(m_SubmitClip);
    public void PlayUndo()          => PlaySfx(m_UndoClip);
    public void PlayClear()         => PlaySfx(m_ClearClip);
    public void PlayButton()        => PlaySfx(m_ButtonClip);
    public void PlayControlEnter()  => PlaySfx(m_ControlEnterClip);
    public void PlayControlExit()   => PlaySfx(m_ControlExitClip);
